...
<div class="card">
  ...
  <div class="card-body card-block">
    <form action="{{URL::to('/admin/list_schedule_uniform/update/'.$schedule_uniform->unf_id)}}" method="POST" class="form-horizontal">
      @csrf
      ...
      <div class="row form-group">
        ...
        <div class="col col-sm-6">
          <input type="text" name="unf_week" placeholder="Masukkan Minggu Ke" class="form-control @error('unf_week') is-invalid @enderror" value="{{ $schedule_uniform->unf_week }}" required>
          @error('unf_week')
          <span class="invalid-feedback" role="alert">
           <strong>{{ $message }}</strong>
         </span>
