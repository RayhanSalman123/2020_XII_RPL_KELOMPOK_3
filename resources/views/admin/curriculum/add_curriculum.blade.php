        ...
        <form action="{{URL::to('/admin/list_curriculum/add_curriculum')}}" method="POST" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col col-sm-6">
                    <input type="text" name="curriculum_name" placeholder="Masukkan Kurikulum" class="form-control @error('curriculum_name') is-invalid @enderror" value="{{old('curriculum_name')}}">
