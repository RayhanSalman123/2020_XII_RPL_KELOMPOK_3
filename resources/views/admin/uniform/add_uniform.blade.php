  ...
  <div class="card-body card-block">
    <form action="{{URL::to('/admin/list_uniform')}}" method="POST" class="form-horizontal">
      ...
      <div class="row form-group">
        ...
        <div class="col col-sm-6">
          <input type="text" name="unf_name_uniform" placeholder="Masukkan Nama Seragam" class="form-control @error('unf_name_uniform') is-invalid @enderror" value="{{old('unf_name_uniform')}}" required>
