                            ...
                            <form method="POST" action="{{ route('register') }}" id="submitForm">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input id="usr_name" type="text" placeholder="Nama" class="form-control @error('usr_name') is-invalid @enderror" name="usr_name" value="{{ old('usr_name') }}" autocomplete="usr_name" autofocus>
